    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ isset($product) ? route('admin.product.update', $product->product_id) : route('admin.product.store') }}"
                ...
                <div class="mb-3">
                    <label for="main_img_url" class="form-label">Ảnh đại diện sản phẩm</label>
                ...
                <div class="mb-3">
                    ...
                    <div id="existingImages" class="d-flex flex-wrap gap-2">
                        ...
                        <div class="position-relative border rounded overflow-hidden " style="width:120px;height:160px;">
                            <img src="{{ asset('storage/'.$img->image_url) }}" alt="Ảnh"
                                style="object-fit:cover;width:100%;height:80%;">
                            {{-- Input sort_order --}}
                            <input type="number" name="sort_orders[{{ $img->image_id }}]"
                                value="{{ $img->sort_order }}" class="form-control form-control-sm mt-1"
                                placeholder="Thứ tự" min="0">
                            <button type="button"
